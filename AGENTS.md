...
- Use the issue templates under `.github/ISSUE_TEMPLATE/` and the PR template; branch naming, commit style and the review/merge mechanics are documented in `docs/github-workflow.md`.
