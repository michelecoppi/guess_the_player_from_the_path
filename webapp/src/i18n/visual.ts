...
const copy = {
  ...
  reportPlaceholder: [
    ...
    "E.g. Day #462, Milan 2011-2015: the appearances look wrong",
    "Ej. Día #462, Milan 2011-2015: las apariciones parecen incorrectas",
  ],
  reportSubmit: ["Invia segnalazione", "Send report", "Enviar notificación"],
  reportSending: ["Invio…", "Sending…", "Enviando…"],
  reportSent: [
    "Segnalazione inviata. Grazie: la leggiamo in chat con il bot.",
    "Report sent. Thanks - we'll read it in the bot's private chat.",
    "Notificación enviada. Gracias, la leeremos en el chat del bot.",
  ],
  reportError: [
