...
export function createTestReferralDashboardResponse(
  overrides: Record<string, any> = {},
): any {
  return {
    qualified: 2,
    required_days: 5,
    link: "https://t.me/test_bot?start=ref_test123",
    friends: [
      { name: "Luca", days: 3, status: "pending" },
      { name: "Andrea", days: 1, status: "pending" },
      { name: "Giulia", days: 5, status: "qualified" },
      { name: "Sara", days: 5, status: "qualified" },
    ],
        ...
        items: [
          {
            ...
            kind: "frame",
            name: "L'Intesa",
            description: "Cornice tattica a 3 nodi",
            price: 0,
            full_price: 0,
            missing: [],
            achievement: null,
        ...
        items: [
          {
            ...
            kind: "card",
            name: "La Lavagna",
            description: "Sfondo tattico a 5",
            price: 0,
            full_price: 0,
            missing: [],
            achievement: null,
            progress: 0,
            style: { finish: "tactics" },
            grants: [],
            owned: false,
            equipped: false,
            free: false,
        ...
        items: [
          {
            ...
            kind: "card",
            name: "Il Tuo Undici",
            description: "La formazione al completo",
            price: 0,
            full_price: 0,
            missing: [],
            achievement: null,
          ...
          {
            id: "referral_undici_frame",
            kind: "frame",
            name: "Cornice XI",
            description: "11 nodi sul profilo",
            price: 0,
            full_price: 0,
            missing: [],
            achievement: null,
